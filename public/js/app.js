...
/* harmony import */ var noty__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(noty__WEBPACK_IMPORTED_MODULE_2__);
 //axios lrary is used for post the dat to other page
...
function initAdmin(socket) {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/admin/order', {
    headers: {
  ...
  function renderItems(items) {
    "";
    var parsedItems = Object.values(items); // console.log(items)
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
 ...
 //NOTY is a notification library that makes it easy to create alert - success - error - warning 
...
function updatecart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/updatecart', pizza).then(function (res) {
    // console.log(res)
...
addtocart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); //JSON.parse basicially used for convert the string  into object
...
var status = document.querySelectorAll('.status_line'); // console.log(status)
...
updatestatus(order); //server

var socket = io();
Object(_admin_js__WEBPACK_IMPORTED_MODULE_2__["initAdmin"])(socket); // make a join request   for rooom
...
socket.on('orderUpdated', function (data) {
  var updateOrder = _objectSpread({}, order); // recieve a copy of any object


  updateOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_3___default()().format();
...
__webpack_require__(/*! C:\Users\Computer Empires\Complete web development\Pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Computer Empires\Complete web development\Pizza\resources\scss\app.scss */"./resources/scss/app.scss");
